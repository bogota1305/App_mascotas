...
class _MapHomeState extends State<MapHome> {
  ...
  Widget build(BuildContext context) {
    ...
    return GoogleMap(
      ...
      onMapCreated: (controller) async {
        ...
        LatLng veterinaryLocation = LatLng(
          widget.veterinary?.ubicacion.latitud ?? 0,
          widget.veterinary?.ubicacion.longitud ?? 0,
        );
        addMarker(
          veterinaryLocation,
          'Veterinaria',
          widget.veterinary?.nombre ?? '',
          null,
          '',
          false,
          true,
        ...
        for (User cuidador in widget.cuidadores) {
          addMarker(
            LatLng(cuidador.alojamiento?.ubicacion.latitud ?? 0,
                cuidador.alojamiento?.ubicacion.longitud ?? 0),
            cuidador.id ?? '',
            cuidador.nombre,
            cuidador,
  ...
  void addMarker(
    ...
    final User cuidador =
        user ?? widget.logedUserController.createDefaultUser();
              ...
              return Padding(
                ...
                child: Visibility(
                  ...
                  child: HousingOrRequestCard(
                    ...
                    favorite: cuidador.favorite ?? false,
